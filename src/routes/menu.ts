        ...
        form: {
          ...
          fields: [
            ...
            },
            {
              ...
              name: 'createLogPostRetentionDays',
              label: 'Auto-delete entries older than X days (0 = keep forever)',
              defaultValue: 30,
            },
            {
              type: 'boolean' as const,
              name: 'createLogPostClearLog',
              label: 'Clear all existing log data now',
              defaultValue: false,
            },
          ],
        },
          ...
          fields: [
            {
              ...
              label: 'Load notes',
              type: 'string',
              defaultValue: 'Click View to continue',
            },
          ],
        },
      },
